...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        # party details
        # assert that "party details" does not occur in the template that's rendered when session[rsvp] = False
        result = self.client.get("/")
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        #make a get request to /games and assign it to variable result
        result = self.client.get('/games')

        self.assertIn(b"Red Flags", result.data)
        self.assertIn(b"Gloomhaven", result.data)
        self.assertIn(b"Eldritch Horror", result.data)
